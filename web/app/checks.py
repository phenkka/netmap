"""шесть проверок конфигурации из раздела 3 бизнес-модели

Проверяется фактическая конфигурация устройства, а не документация. Правила
разбора лежат в драйвере вендора, здесь только состав проверок и их смысл.
"""
