"""эталонная конфигурация и сверка с ней

Эталон это утверждённый администратором образец настроек. Он заводится из
снятой версии, назначается на устройства того же производителя, и расхождение
с ним считается при каждом новом снимке, а не на каждый запрос карты.
"""
